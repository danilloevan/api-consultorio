...
public class PacienteController {
	...
	@PostMapping
	@Transactional
	public ResponseEntity<PacienteDetalhamentoDTO> cadastrar(@RequestBody @Valid PacienteCadastroDTO dados, UriComponentsBuilder uriBuilder) {
	...
	public ResponseEntity<Page<PacienteListagemDTO>> listar(
		...
		Page<PacienteListagemDTO> page = repository.findByExcluidoFalse(paginacao).map(PacienteListagemDTO::new);
	...
	@PutMapping
	@Transactional
	public ResponseEntity<PacienteDetalhamentoDTO> alterar(@RequestBody @Valid PacienteAtualizacaoDTO dados) {
